...
import java.util.HashMap;    // HashMap implementation for the velocity map; keyed by Platform reference
import java.util.List;       // List interface for fallingBlocks and groundPlatforms parameters
import java.util.Map;        // Map interface for the velocityMap; Platform → Float velocity
